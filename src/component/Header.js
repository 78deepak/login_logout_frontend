...
function Header({ isAuthenticated, setIsAuthenticated }) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full flex flex-row items-center justify-between sm:justify-around p-4 border-b-2 bg-gradient-to-r from-cyan-500 to-yellow-500  z-50 shadow-md">
      <Link
